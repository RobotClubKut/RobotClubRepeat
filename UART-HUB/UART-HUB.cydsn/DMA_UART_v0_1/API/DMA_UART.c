...
uint8 `$INSTANCE_NAME`_initVar = 0u;
    ...
    volatile uint8 `$INSTANCE_NAME`_txBuffer[`$INSTANCE_NAME`_TX_BUFFER_SIZE];
    ...
    uint8 `$INSTANCE_NAME`_errorStatus = 0u;
    volatile uint8 `$INSTANCE_NAME`_rxBuffer[`$INSTANCE_NAME`_RX_BUFFER_SIZE];
    ...
    volatile uint8 `$INSTANCE_NAME`_rxBufferOverflow   = 0u;
        ...
        volatile uint8 `$INSTANCE_NAME`_rxAddressMode = `$INSTANCE_NAME`_RX_ADDRESS_MODE;
    ...
    *******************************************************************************/
    void `$INSTANCE_NAME`_PutString(const char8 string[]) `=ReentrantKeil($INSTANCE_NAME . "_PutString")`
    {
        ...
        if(`$INSTANCE_NAME`_initVar != 0u)
        {
            ...
            {
                `$INSTANCE_NAME`_PutChar((uint8)string[bufIndex]);
                bufIndex++;
            }
        }
    }
